    ...
    if (status) {
        ...
        if (currentUser) {
            ...
            if (isAdmin) {
                ...
                status.innerHTML +=
                    "<br>У вас нет прав администратора.";
            }

        } else {

            status.textContent =
                "Войдите через аккаунт Supabase.";
        }
    }
        ...
        if (status) {
            ...
            if (isAdmin) {
                ...
                status.innerHTML =
                    ...
                    "Аккаунт вошёл, но прав администратора нет." +
                    "</span>";
            }
        }
...
function getAuthErrorMessage(error) {
    ...
    if (
        ...
        return "Подтверди email в почте Supabase.";
    }
