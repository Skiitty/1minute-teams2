...
function getMainPlayers() {
const result = [];

```
for (let i = 0; i < STARTERS.length; i++) {
    const player = findPlayer(STARTERS[i]);
...
for (let i = 0; i < SUBSTITUTES.length; i++) {
    const player = findPlayer(SUBSTITUTES[i]);
...
const teamInput =
    document.getElementById("playerEditTeam");
...
const newName =
    document.getElementById("playerEditName").value.trim();

const country =
    document.getElementById("playerEditCountry").value.trim();

const role =
    document.getElementById("playerEditRole").value;

const avatar =
    document.getElementById("playerEditAvatar").value.trim();

const faceit =
    document.getElementById("playerEditFaceit").value.trim();

const steam =
    document.getElementById("playerEditSteam").value.trim();
...
try {
    ...
    alert(
        ...
        "Проверь настройки RLS в Supabase."
    );
}
```
