...
/* =====================================================
ОПРЕДЕЛЕНИЕ ОСНОВНОЙ СОСТАВ / ЗАМЕНА
===================================================== */
...
/*
   Здесь ВСЕГДА будет 1Minute.
   Никакие фильтры больше не нужны.
*/
...
/*
Оставляем функцию,
чтобы старый HTML не выдавал ошибку,
если где-то остался её вызов.
*/
